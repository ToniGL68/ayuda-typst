...
- Las reglas se pueden aplicar a un texto pasado com parámetro y también a una parte del contenido si se usa ```typ #show``` dentro de un bloque con ```typ #[#show:reglas... contenido]```:
